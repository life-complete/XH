...
public class HisDataMsSqlOnWorker implements IDataOnWorker {
	...
	@WorkAutowired
	private IDataMssqlService dataMssqlService;
	...
	private Object readWardareaHandler(Object params) {
		return this.dataMssqlService.getWardareaList(params);
	}

	private Object readDepartmentHandler(Object params) {
		return this.dataMssqlService.getDepartmentList(params);
	}

	private Object readPotherHandler(Object params) {
		return this.dataMssqlService.getPotherList(params);
	}

	private Object readPatientHandler(Object params) {
		return this.dataMssqlService.getPatientList(params);
	}

	private Object readStaffHandler(Object params) {

		return this.dataMssqlService.getStaffList(params);
	}

	@Override
	public boolean recvData(Object args) {

		return this.dataMssqlService.saveBloodGlucose(args);
	}
}
