...
public class HisPushGeJiuYiYuan extends HisBasePushOnWorker {
	protected static final Logger LOGGER = LoggerFactory.getLogger(HisPushGeJiuYiYuan.class);

	@Override
	public String versionName() {
		return String.valueOf("个旧人民医院对接");
	}
		...
		try {
			if (obList instanceof ArrayList) {
				...
				for (HisPatient patient : $list) {
					...
					$patientList.setWist_Band_Code("ZY"+cardNo);
...
//					$patientList.setDepartment(wardArea);
