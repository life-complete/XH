...
public class HisPushNanChuanRenMinYiYuanOnWork extends HisBasePushOnWorker {
	protected static final Logger LOGGER = LoggerFactory.getLogger(HisPushNanChuanRenMinYiYuanOnWork.class);
	
	@Override
	public String versionName(){
		 return String.valueOf("南川人民医院对接");
	}
