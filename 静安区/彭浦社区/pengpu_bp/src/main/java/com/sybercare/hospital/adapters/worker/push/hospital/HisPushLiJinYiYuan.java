...
public class HisPushLiJinYiYuan extends HisBasePushOnWorker {
	protected static final Logger LOGGER = LoggerFactory.getLogger(HisPushLiJinYiYuan.class);

	@Override
	public String versionName() {
		return String.valueOf("利津医院对接");
	}
