...
public class HisPushChiFengYiYuan extends HisBasePushOnWorker {
	protected static final Logger LOGGER = LoggerFactory.getLogger(HisPushChiFengYiYuan.class);

	@Override
	public String versionName() {
		return String.valueOf("赤峰医院对接");
	}
