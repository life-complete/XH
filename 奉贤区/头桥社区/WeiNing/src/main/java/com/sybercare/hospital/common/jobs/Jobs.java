...
public class Jobs {
	...
	public void doBmiIt() {
		try{
			...
			printwrites("C:/Hesicare/java项目/logs/sg/"+"/"+new SimpleDateFormat("yyyy-MM-dd").format(new Date()) +".txt","job 身高定时器：" + Constants.convert(new Date(), Constants.format2));
	...
	public void doXueTangIt() {
		try {
			printwrites("C:/Hesicare/java项目/logs/xt/"+"/"+new SimpleDateFormat("yyyy-MM-dd").format(new Date()) +".txt","job 血糖定时器：" + Constants.convert(new Date(), Constants.format2));
	...
	public void doXueYaIt() {
		try {
			...
			printwrites("C:/Hesicare/java项目/logs/xy/"+"/"+new SimpleDateFormat("yyyy-MM-dd").format(new Date()) +".txt","job 血压定时器：" + Constants.convert(new Date(), Constants.format2));
	...
	public boolean requestBP(List<BloodPressure> bloodPressure) throws Exception {
		...
		String url="http://10.232.207.15:8027/api/MeasureDataApi/MeasureData";
		...
		printwrites("C:/Hesicare/java项目/logs/xy/"+new SimpleDateFormat("yyyy-MM-dd").format(new Date()) +".txt","请求数据：" + json.toString());
		String result=sendHttpPost(url,json.toString());
		printwrites("C:/Hesicare/java项目/logs/xy/"+new SimpleDateFormat("yyyy-MM-dd").format(new Date()) +".txt",result);
	...
	public boolean requestSG(PatientBmiView patientBmiView) throws Exception {
		...
		JSONObject json = JSONObject.fromObject(patdata, jsonConfig);
		//System.out.println("请求数据：" + json.toString());
		printwrites("C:/Hesicare/java项目/logs/sg/"+new SimpleDateFormat("yyyy-MM-dd").format(new Date()) +".txt","请求数据：" + json.toString());
		String result=sendHttpPost(url,json.toString());
		printwrites("C:/Hesicare/java项目/logs/sg/"+new SimpleDateFormat("yyyy-MM-dd").format(new Date()) +".txt",result);
		JSONObject resultJson = JSONObject.fromObject(result);
		String code = resultJson.getString("retcode");
		if (code.equals("0")) {
			requestXT = true;
	...
	public boolean requestXT(BloodGlucose bloodGlucose) throws Exception {
		...
		JSONObject json = JSONObject.fromObject(patdata, jsonConfig);
		//System.out.println("请求数据：" + json.toString());
		printwrites("C:/Hesicare/java项目/logs/xt/"+new SimpleDateFormat("yyyy-MM-dd").format(new Date()) +".txt","请求数据：" + json.toString());
		String result=sendHttpPost(url,json.toString());
		printwrites("C:/Hesicare/java项目/logs/sg/"+new SimpleDateFormat("yyyy-MM-dd").format(new Date()) +".txt",result);
		JSONObject resultJson = JSONObject.fromObject(result);
		String code = resultJson.getString("retcode");
