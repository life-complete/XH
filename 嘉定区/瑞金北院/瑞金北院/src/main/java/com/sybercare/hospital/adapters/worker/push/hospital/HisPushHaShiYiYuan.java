...
public class HisPushHaShiYiYuan extends HisBasePushOnWorker {
	protected static final Logger LOGGER = LoggerFactory.getLogger(HisPushHaShiYiYuan.class);

	@Override
	public String versionName() {
		return String.valueOf("哈十医院对接");
	}
		...
		try {
			if (obList instanceof ArrayList) {
				...
				for (HisPatient patient : $list) {
					...
					$patientList.setWist_Band_Code(cardNo);	//腕带码
