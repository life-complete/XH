...
public class HisPushXiNingHaiHuOnWorker extends HisBasePushOnWorker {
	protected static final Logger LOGGER = LoggerFactory.getLogger(HisPushXiNingHaiHuOnWorker.class);

	@Override
	public String versionName() {
		return String.valueOf("西宁海湖医院对接");
	}
