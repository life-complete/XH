 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://pda.org/", wsdlLocation = "http://172.21.8.30:8080/WebServices/Service.asmx?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://pda.org/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://172.21.8.30:8080/WebServices/Service.asmx?wsdl");
    ...
    public ServiceSoap getServiceSoap() {
        return super.getPort(new QName("http://pda.org/", "ServiceSoap"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://pda.org/", "ServiceSoap"), ServiceSoap.class, features);
    }
